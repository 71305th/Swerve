...
public final class Constants {
  ...
  public static class MotorConstants {
    ...
    // Rotor Offset
    public static final double kLeftFrontRotorOffset = 48.076;
    public static final double kRightFrontRotorOffset = 138.164;
    public static final double kLeftRearRotorOffset = 51.328;
    public static final double kRightRearRotorOffset = 85.957;
  ...
  public static class PIDConstants {
    // Rotor PID constants
      ...
      public static final double kRotor_kI = 0.0002;
  ...
  public static final class FieldConstants {
    ...
    public static Map<Integer, Translation3d> NodeMap = new HashMap<>(){{
      ...
      put(103, new Translation3d(16.1735, 0, 1.1695));
      ...
      put(109, new Translation3d(16.1735, 0, 1.1695));
      put(201, new Translation3d(15.3750, 0, 0));
      put(202, new Translation3d(15.7462, 0, 0.8636));
      put(203, new Translation3d(16.1735, 0, 1.1695));
      ...
      put(603, new Translation3d(0.3683, 0, 1.1695));
      put(604, new Translation3d(1.1747, 0, 0));
      put(605, new Translation3d(0.8001, 0, 0.8636));
      put(606, new Translation3d(0.3683, 0, 1.1695));
      ...
      put(703, new Translation3d(0.3683, 0, 1.1695));
      ...
      put(709, new Translation3d(0.3683, 0, 1.1695));
      put(801, new Translation3d(1.1747, 0, 0));
      put(802, new Translation3d(0.8001, 0, 0.8636));
      put(803, new Translation3d(0.3683, 0, 1.1695));
      ...
      put(809, new Translation3d(0.3683, 0, 1.1695));

      put(41, new Translation3d(15.3750, 0, 0));
      put(51, new Translation3d(15.7462, 0, 0.8636));
      put(61, new Translation3d(16.1735, 0, 1.1695));
      ...
      put(63, new Translation3d(16.1735, 0, 1.1695));
      put(44, new Translation3d(15.3750, 0, 0));
      put(54, new Translation3d(15.7462, 0, 0.8636));
      put(64, new Translation3d(16.1735, 0, 1.1695));
      ...
      put(17, new Translation3d(0.3683, 0, 1.1695));
      put(38, new Translation3d(1.1747, 0, 0));
      put(28, new Translation3d(0.8001, 0, 0.8636));
      put(18, new Translation3d(0.3683, 0, 1.1695));
      ...
      put(14, new Translation3d(0.3683, 0, 1.1695));
      ...
      put(16, new Translation3d(0.3683, 0, 1.1695));
      put(31, new Translation3d(1.1747, 0, 0));
      put(21, new Translation3d(0.8001, 0, 0.8636));
      put(11, new Translation3d(0.3683, 0, 1.1695));
      ...
      put(13, new Translation3d(0.3683, 0, 1.1695));
    }};
  }
